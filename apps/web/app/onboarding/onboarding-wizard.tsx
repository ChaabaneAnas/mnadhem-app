    ...
    <div className="w-full max-w-lg">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <Button
          ...
          className="h-auto flex flex-col items-start gap-4 rounded-xl border-slate-200 bg-white p-6 text-left whitespace-normal transition-all duration-150 hover:border-slate-400 hover:bg-white hover:shadow-sm focus:ring-2 focus:ring-slate-400"
        >
  ...
  return (
    <div className="w-full max-w-sm">
      <Button
        ...
        variant="link"
        onClick={onBack}
        className="mb-6 flex items-center gap-1 p-0 h-auto text-sm text-slate-500 hover:text-slate-800 hover:no-underline transition-colors"
      >
        <ChevronLeft size={15} />
        Back
      </Button>
